...
function validateEnvironment() {
    const required = ["PORTAL_IP", "PORTAL_INTERFACE", "SESSION_TIMEOUT", "CONTRACT_ID"];
    ...
    return {
        portalInterface: process.env.PORTAL_INTERFACE,
        portalIP: process.env.PORTAL_IP,
        portalPort: Number(process.env.PORTAL_PORT) || 80,
    };
}
